...
public class buscarContacto extends javax.swing.JDialog {
    ...
    public buscarContacto(java.awt.Frame parent, boolean modal, Aplicacion app,ventanaPrincipal ventana) {
        super(parent, modal);
        initComponents();
    ...
    private void btnbuscarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnbuscarActionPerformed
        try {
            ...
            if (correo.isEmpty()) {
                errores += "❌ El campo de correo no puede estar vacío.\n";
            }
            if (correo.indexOf('@') == -1) {
                errores += "❌ El correo debe contener '@'.\n";
            }
            ...
            Amigo amigo = app.buscarAmigo(correo);
            String mensaje = "Nombre: " + amigo.getNombre() + "\nTeléfono: " + amigo.getTelefono();
